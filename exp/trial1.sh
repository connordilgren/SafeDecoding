...
#SBATCH --time=10:00:00                     # Maximum time for job (30 hours)
...
python ~/SafeDecoding/exp/defense.py --model_name vicuna --attacker GCG --defender nodefense --disable_GPT_judge